...
class TestDeviceCorrelator:
    ...
    def test_correlate_timing(self):
        ...
        wifi_devices = {"11:22:33:44:55:66": {"first_seen": now, "last_seen": now, "essid": "Network1"}}

        bt_devices = {"77:88:99:AA:BB:CC": {"first_seen": now, "last_seen": now, "name": "Device1"}}
    ...
    def test_correlate_no_overlap(self):
        ...
        correlator = DeviceCorrelator(time_window_seconds=30, min_confidence=0.6)

        now = datetime.now()
        old = now - timedelta(hours=1)

        wifi_devices = {"11:22:33:44:55:66": {"first_seen": old, "last_seen": old, "essid": "OldNetwork"}}

        bt_devices = {"77:88:99:AA:BB:CC": {"first_seen": now, "last_seen": now, "name": "NewDevice"}}
    ...
    def test_correlate_manufacturer_match(self):
        ...
        wifi_devices = {
            "11:22:33:44:55:66": {"first_seen": now, "last_seen": now, "manufacturer": "Apple", "essid": "Network"}
        }

        bt_devices = {
            "77:88:99:AA:BB:CC": {"first_seen": now, "last_seen": now, "manufacturer": "Apple", "name": "iPhone"}
        }
    ...
    def test_correlate_sorting(self):
        ...
        correlator = DeviceCorrelator(time_window_seconds=60, min_confidence=0.0)
        now = datetime.now()

        wifi_devices = {
            "AA:BB:CC:11:11:11": {"first_seen": now, "last_seen": now, "manufacturer": "Apple"},
            "11:22:33:44:55:66": {"first_seen": now, "last_seen": now},
        }

        bt_devices = {
            "AA:BB:CC:22:22:22": {"first_seen": now, "last_seen": now, "manufacturer": "Apple"},
            "77:88:99:AA:BB:CC": {"first_seen": now, "last_seen": now},
        }
...
class TestGetCorrelations:
    ...
    def test_get_correlations_live(self, mock_db, mock_correlator):
        ...
        mock_correlator.correlate.return_value = [
            {"wifi_mac": "AA:AA:AA:AA:AA:AA", "bt_mac": "BB:BB:BB:BB:BB:BB", "confidence": 0.8}
        ]
        ...
        results = get_correlations(wifi_devices=wifi, bt_devices=bt, include_historical=False)
    ...
    def test_get_correlations_historical(self, mock_db, mock_correlator):
        ...
        results = get_correlations(wifi_devices={}, bt_devices={}, include_historical=True)
    ...
    def test_get_correlations_deduplication(self, mock_db, mock_correlator):
        ...
        results = get_correlations(wifi_devices=wifi, bt_devices=bt, include_historical=True)

        # Should deduplicate - only one entry for the same device pair
        matching = [r for r in results if r["wifi_mac"] == "AA:AA:AA:AA:AA:AA"]
...
class TestCorrelationReason:
    ...
    def test_reason_same_oui(self):
        ...
        wifi_devices = {"AA:BB:CC:11:22:33": {"first_seen": now, "last_seen": now}}

        bt_devices = {"AA:BB:CC:44:55:66": {"first_seen": now, "last_seen": now}}
    ...
    def test_reason_timing(self):
        ...
        wifi_devices = {"11:22:33:44:55:66": {"first_seen": now, "last_seen": now}}

        bt_devices = {
            "77:88:99:AA:BB:CC": {"first_seen": now + timedelta(seconds=5), "last_seen": now + timedelta(seconds=5)}
        }
