...
class TestAgentClient:
    ...
    def test_get_status(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"running_modes": ["adsb", "sensor"], "uptime": 3600, "push_enabled": True}
        mock_response.content = b"{}"
        mock_response.raise_for_status = Mock()
        mock_get.return_value = mock_response
    ...
    def test_get_mode_data(self, mock_get):
        ...
        mock_response.json.return_value = {
            "mode": "adsb",
            "data": [{"icao": "ABC123", "altitude": 35000}, {"icao": "DEF456", "altitude": 28000}],
        }
        mock_response.content = b"{}"
        mock_response.raise_for_status = Mock()
        mock_get.return_value = mock_response
    ...
    def test_create_client_from_agent(self):
        ...
        agent = {"id": 1, "name": "test-agent", "base_url": "http://192.168.1.50:8020", "api_key": "secret123"}
...
class TestDatabaseAgentCRUD:
    ...
    def test_create_agent(self):
        ...
        agent_id = create_agent(
            name="sensor-1", base_url="http://192.168.1.50:8020", api_key="secret", description="Test sensor node"
        )
    ...
    def test_get_agent(self):
        ...
        agent_id = create_agent(name="sensor-1", base_url="http://192.168.1.50:8020")
    ...
    def test_update_agent(self):
        ...
        result = update_agent(agent_id, base_url="http://192.168.1.100:8020", description="Updated description")
