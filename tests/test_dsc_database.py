...
def temp_db():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("utils.database.DB_PATH", test_db_path), patch("utils.database.DB_DIR", test_db_dir):
...
class TestDSCAlertsCRUD:
    ...
    def test_store_minimal_alert(self, temp_db):
        ...
        alert_id = store_dsc_alert(source_mmsi="366000001", format_code="116", category="ROUTINE")
    ...
    def test_store_alert_with_raw_message(self, temp_db):
        ...
        alert_id = store_dsc_alert(source_mmsi="232123456", format_code="100", category="DISTRESS", raw_message=raw)
    ...
    def test_store_alert_with_destination(self, temp_db):
        ...
        alert_id = store_dsc_alert(
            source_mmsi="232123456", format_code="112", category="INDIVIDUAL", dest_mmsi="366000001"
        )
...
class TestDSCDatabaseIntegration:
    ...
    def test_multiple_vessel_alerts(self, temp_db):
        ...
        for mmsi, _country, nature in vessels:
            store_dsc_alert(source_mmsi=mmsi, format_code="100", category="DISTRESS", nature_of_distress=nature)
