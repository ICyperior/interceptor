...
def test_send_deauth_success(client, mock_app_module, mocker):
    ...
    payload = {"bssid": "AA:BB:CC:DD:EE:FF", "count": 10, "interface": "wlan0mon"}
...
def test_crack_handshake_success(client, mocker):
    ...
    mock_run.return_value = MagicMock(stdout="KEY FOUND! [ secret123 ]", stderr="", returncode=0)
...
def test_get_wifi_networks(client, mock_app_module):
    ...
    mock_app_module.wifi_networks = {"AA:BB:CC:DD:EE:FF": {"essid": "Home-WiFi", "bssid": "AA:BB:CC:DD:EE:FF"}}
